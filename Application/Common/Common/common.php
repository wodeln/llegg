...
//    $resp = $c->execute($req);
    ...
    $url = "http://sh2.ipyy.com/sms.aspx?action=send&userid=&account=$c->appkey&password=$c->secretKey&mobile=$mobile&content=您本次操作的验证码为 $code 有效期5分钟。【上海菜道】&sendTime=&extno=";
    $resp=curl_file_get_contents($url);
    //if (!$resp)
