        ...
        <div class="navbar navbar-default">
                            <form action="<?php echo U('Admin/order/export_order');?>" id="search-form2" class="navbar-form form-inline" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(is_array($shippingList)): foreach($shippingList as $k=>$v): ?><option value="<?php echo ($v["code"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
...
<div id="ajax_return" style="margin-top: 0px;"></div>
<script>
    ...
    function ajax_get_table(tab,page){
        cur_page = page; //当前页面 保存为全局变量
            $.ajax({
                type : "POST",
                url:"/index.php/Admin/order/ajaxdeliverytotalprint/p/"+page,//+tab,
