...
<link rel="stylesheet" href="/Template/mobile/new/Static/css/mobiscroll.custom-3.0.0-beta2.min.css">
<script type="text/javascript" src="/Template/mobile/new/Static/js/jquery.js"></script>
<script src="/Public/js/global.js"></script>
<script src="/Public/js/mobile_common.js"></script>
<script src="/Public/js/mobiscroll.custom-3.0.0-beta2.min.js"></script>
	    ...
	    <section class="address">
	      <div class="address-info" >收货人:
            ...
            <div class="address-info">
                <p class="address-name">配送小区：<?php echo ($region_list[$address['village']]['name']); ?></p>
                <p class="address-phone">配送地址：<?php echo ($address["address"]); ?></p>
                <input type="hidden" id="village_id" value="<?php echo ($address["village"]); ?>">
            </div>
	     <!-- <div class="address-details">配送地址：<?php echo ($address["address"]); ?></div>-->
